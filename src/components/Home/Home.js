...
//                                 alt="Logo"
//                             />
//                             <h2 className="text-5xl font-bold sm:text-6xl"> {/* Increased font size */}
//                                 👋 Hii I'm Harsh
//                             </h2>
...
//                         </div>
//                         <div className="flex flex-col items-center transition-transform transform hover:scale-110">
//                             <img src={'./c++ file.png'} alt="Appwrite" className="h-16 w-16 animate-bounce" />
...
//                         <div className="flex flex-col items-center transition-transform transform hover:scale-110">
//                             <img src={'./react.svg'} alt="HTML" className="h-16 w-16 animate-bounce" />
//                             <span className="mt-2">React</span>
//                         </div>


//                         <div className="flex flex-col items-center transition-transform transform hover:scale-110">
//                             <img src={'./Express-js.png'} alt="HTML" className="h-16 w-16 animate-bounce" />
...
//                         <div className="flex flex-col items-center transition-transform transform hover:scale-110">
//                             <img src={'./nodejs.svg'} alt="MongoDB" className="h-16 w-16 animate-bounce" />
